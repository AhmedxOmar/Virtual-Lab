...
const PasswordTab = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!validatePassword(newPassword)) {
            setError("Password must be at least 8 characters, include an uppercase letter, lowercase letter, and a number.")
            return;
        }
    ...
    return (
        <div className='passwordTab bg-[#1a1a1a] p-6 w-140 text-white rounded-[20px]'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                <button type='submit' className='w-128 bg-purple-500 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded-lg transition'>Save Changes</button>
            </form>
