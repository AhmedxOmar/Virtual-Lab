    ...
    return (
        <aside className='proflieSidebar w-64 ml-[5%] text-white h-full overflow-y-auto p-4'>
            <ul className='flex flex-col  relative'>
                ...
                <li className={`sidebarTab flex gap-4 p-2 items-center inter-bold ${activeTab === "overview" ? "active" : ""}`} onClick={() => setActiveTab("overview")}>
                    <FaUser size={15} className='sidebarIcon' /> Overview
                </li>
                <hr className='my-3 text-[#272727]' />
                <li className='sidebarLabel mb-2'>Progress</li>
                <li className={`sidebarTab flex gap-4 p-2 items-center inter-bold ${activeTab === "achievements" ? "active" : ""}`} onClick={() => setActiveTab("achievements")}>
