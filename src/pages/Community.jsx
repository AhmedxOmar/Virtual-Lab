        ...
        <div className="bg-[#1e1f22] text-white font-sans">
                ...
                <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10">
                    <div className="text-center md:text-left max-w-xl">
                        ...
                        <p className="text-lg text-gray-300 mb-6">
                            Connect with other learners, ask questions, share your projects, and stay up-to-date — all in one place.
                        </p>
                        <a
                            href="https://discord.gg/2bZ2DnQrwp"
                            target="_blank"
            ...
            <section className="py-16 px-6 md:px-16 bg-[#2b2d31]">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-gray-300 mb-12">A supportive space made for learners like you.</p>
                    <div className="grid md:grid-cols-3 gap-8 text-left">
                        <div className="bg-[#1e1f22] p-6 rounded-xl shadow-lg">
                            <h3 className="text-xl font-semibold mb-2 text-[#5865F2]">🤝 Connect</h3>
                            <p className="text-gray-300">Meet students, developers, and tech lovers from across the country.</p>
                        </div>
                        <div className="bg-[#1e1f22] p-6 rounded-xl shadow-lg">
                            <h3 className="text-xl font-semibold mb-2 text-[#5865F2]">💬 Ask & Share</h3>
                            <p className="text-gray-300">Get help with projects, ask questions, or share your success.</p>
                        </div>
                        <div className="bg-[#1e1f22] p-6 rounded-xl shadow-lg">
                            <h3 className="text-xl font-semibold mb-2 text-[#5865F2]">📢 Stay Updated</h3>
                            <p className="text-gray-300">Announcements, events, and virtual sessions—all in one place.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-6 md:px-16">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <p className="text-gray-300 mb-10">Take a sneak peek at our Discord server.</p>
            ...
            <footer className="bg-[#1e1f22] py-10 px-6 md:px-16 border-t border-gray-700 text-center">
                <div className="max-w-6xl mx-auto">
                    <p className="text-gray-400 mb-2">© 2025 Virtual Lab. All rights reserved.</p>
